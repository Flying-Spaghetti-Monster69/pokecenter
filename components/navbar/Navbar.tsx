...
const Navbar = ({ user }: { user: extrasUser }) => {
  return (
    <nav className="z-50 top-0 left-0 right-0 fixed bg-gradient border-b-2 border-primary dark:border-dark-primary h-16 w-full  flex items-center justify-between py-2 px-12">
      <Link
        href={"/"}
